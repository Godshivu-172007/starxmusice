...
๏ 𝐌𝐀𝐃𝐄 𝐁𝐘 ➠ [𝖲𝗎𝗇𝗀𝗃𝗂𝗇𝗐𝗎172007 📿](https://t.me/Sungjinwu172007)
➖➖➖➖➖➖➖➖➖➖➖
""",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(f"⦿ ᴀᴅᴅ ᴍᴇ ⦿", url=f"https://t.me/StarXMusic_bot?startgroup=true")]])
        )
    except Exception as e:
        LOGGER.error(e)
    try:

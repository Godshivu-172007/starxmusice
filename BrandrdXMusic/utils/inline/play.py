...
def stream_markup_timer(_, vidid, chat_id, played, dur):
    ...
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="🥀 ᴏᴡɴᴇʀ 🥀", url=f"https://t.me/Sungjinwu172007"
            ),
            InlineKeyboardButton(
                text="🥀 ᴄʜᴀᴛ 🥀", url=f"https://t.me/+zofL0InuuzlhNjhl"
            ),
        ],
...
def stream_markup(_, videoid, chat_id):
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton(
                text="🥀 ᴄʜᴀᴛ 🥀", url=f"https://t.me/Dynamic_support_01"
            ),
        ],
        [InlineKeyboardButton(text=_["CLOSE_BUTTON"], callback_data="close")],
    ]
...
[
            InlineKeyboardButton(
                text="🥀 ᴏᴡɴᴇʀ 🥀", url=f"https://t.me/Dynamic_support_01"
            ),
            InlineKeyboardButton(
                text="🥀 ᴄʜᴀᴛ 🥀", url=f"https://t.me/+zofL0InuuzlhNjhl"
            ),
